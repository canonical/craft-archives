...
professional, and get involved in the growing open source community. Craft Archives
...
The Starcraft team at Canonical sets the direction and priorities of Craft Archives. They
...
issues](https://github.com/canonical/craft-archives/issues) first. If you have fresh input,
...
Craft Archives uses a forking, feature-based workflow. Most work on Craft Archives occurs on
...
Start by [creating a personal fork](https://github.com/canonical/craft-archives/fork) of the
...
cd craft-archives
git remote add upstream git@github.com:canonical/craft-archives
git fetch upstream
```
...
```bash
git clone https://github.com/<username>/craft-archives --recurse-submodules
cd craft-archives
git remote add upstream https://github.com/canonical/craft-archives
git fetch upstream
```
...
All significant work in Craft Archives should be tied to an existing issue or ticket.

Once you find an issue that you'd like to work on, it's best to reach out so that a
Craft Archives maintainer can assign the ticket to you before starting. This process varies
...
Craft Archives maintainer will assign it to you.

If you don't find a related issue, [open
one](https://github.com/canonical/craft-archives/issues/new/choose) and indicate that you're
interested in taking it on. When creating the issue, be sure to add any relevant labels.
A Craft Archives maintainer will then review the issue and assign it to you.
...
[Diátaxis](https://diataxis.fr) category for the page. A Craft Archives maintainer will
...
Craft Archives' test suite includes unit and integration tests. If you're not sure which
...
the four categories of [Diátaxis](https://diataxis.fr), the framework that Craft Archives'
...
On GitHub, [open a PR](https://github.com/canonical/craft-archives/compare) for your branch in
Craft Archives.
...
The Craft Archives maintainers try to review every PR in a timely manner, typically within a
