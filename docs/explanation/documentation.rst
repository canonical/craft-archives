...
The documentation is an essential part of Craft Archives. We make documentation a disciplined
...
Craft Archives practices docs-as-code. The document source files are written in
reStructuredText markup and kept inside the Craft Archives source code. Like the rest of the
...
The Craft Archives maintainers try and review every PR in a timely manner, typically within a
...
There is no single way to write, but there are guidelines and patterns that Craft Archives
documents follow:
