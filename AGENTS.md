...
`canonical/craft-archives` is a Python library for managing interaction with software package repositories

## Craft apps and libraries

Craft Archives is used by craft apps, including but not limited to Charmcraft, Debcraft,
